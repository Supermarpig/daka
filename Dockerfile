...
RUN echo "50 1 * * * /usr/local/bin/node /app/src/index.js S" > /var/spool/cron/crontabs/root
RUN echo "50 10 * * * /usr/local/bin/node /app/src/index.js E" >> /var/spool/cron/crontabs/root
